#!/usr/bin/env ruby20
require_relative 'manifest_merge'
gem "minitest"
...
class TestManifestMerge < Minitest::Test
	def setup
		@test_header = <<-END.gsub(/^\t{3}/, '').strip
			...
			realtime reviewboard rtsp ruby_targets_ruby18 ruby_targets_ruby19 ruby_targets_ruby20 samba sasl scanner script sdl sdl-image semantic-desktop session shine shout speech spell sql sqlite sse sse2 ssl startup-notification subversion svg switcher taglib tcl tcpd theora threads tiff tk tools tracker transcode truetype udev udisks unicode upcall upnp upnp-av upower usb userland_GNU v4l vaapi valgrind vcdx vdpau video_cards_dummy video_cards_fbdev video_cards_glint video_cards_intel video_cards_mach64 video_cards_mga video_cards_nouveau video_cards_nv video_cards_r128 video_cards_radeon video_cards_savage video_cards_sis video_cards_tdfx video_cards_trident video_cards_v4l video_cards_vesa video_cards_via video_cards_vmware vnc vorbis webkit winbind wxwidgets x264 xcb xcomposite xinerama xml xmp xosd xscreensaver xtables_addons_account xtables_addons_chaos xtables_addons_condition xtables_addons_delude xtables_addons_dhcpmac xtables_addons_fuzzy xtables_addons_geoip xtables_addons_iface xtables_addons_ipmark xtables_addons_ipp2p xtables_addons_ipset xtables_addons_ipv4options xtables_addons_length2 xtables_addons_logmark xtables_addons_lscan xtables_addons_pknock xtables_addons_psd xtables_addons_quota2 xtables_addons_rawnat xtables_addons_steal xtables_addons_sysrq xtables_addons_tarpit xtables_addons_tee xv xvid zeroconf zlib
